...
```mermaid
flowchart TD
    A["AIコーディングツール普及\n（Copilot, Cursor等）"] --> B["開発工数 30〜70% 削減"]
    B --> C1["顧客：同じ成果物は\n以前より安くできるはず"]
    B --> C2["元請けSIer：自社生産性向上\n→ 外注必要量が減る"]
    C1 --> D["人月単価への\n値下げ圧力"]
    C2 --> E["2次請けへの\n発注量の縮小"]
    D --> F["当社売上 = 人数 × 単価 × 月数\nのすべての項目が同時に下がる"]
    E --> F
...
![グローバルIT企業 AI転換の明暗（2025年実績）](charts/fig3_global.png)
...
![ソフトウェア業の倒産件数推移（帝国データバンク調査）](charts/fig4_bankruptcy.png)
...
![4つの戦略オプション：着手難易度 × ビジネス変化度マトリクス](charts/fig5_strategy.png)
